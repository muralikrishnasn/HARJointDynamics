	...
	while True:
		...
		with open(fileName) as df:
			...
			while True:
				...
				if(currentActionLabel != prevActionLabel and prevActionLabel!='beginning'):
					action_type.append(prevActionLabel)	
					frameCount[prevActionLabel] = prevFrameCount;
	 	 			frameNum = 0 
	 	 		prevActionLabel = currentActionLabel
	 	 		prevFrameCount = frameNum

	 	 	action_type.append(currentActionLabel)
	 		frameCount[prevActionLabel] = prevFrameCount;
		print subject
		print action_type
		print frameStart_list
	 ...
	 # 	 		#third dimesion is the frame number 
				...
				for i in range(0,NJOINTS):
		 	 	 	for j in range(0, NJOINTS):
		 	 			#X_data[j][2] = frameNum;
		 	 				#if currentActionLabel == 'walk':
		 	 				#	print frameNum, X_data
		 	 				#print frameNum,
	  	 		...
	  	 		frameNum += 1
	  	 		#print frameNum, currentActionLabel, frameCount[currentActionLabel], prevActionLabel
	  	 		if(currentActionLabel != prevActionLabel and prevActionLabel!='beginning'):
					
					frameNum = 0
	  	 			outfile = Data_Set_Path + subject+'_' + prevActionLabel + '.csv'
	  	 			print outfile
	 	 		 # 	data ={}
	 	 		 # 	data['FileName']=outfile
	 	 			# data['numberofframes']=frameCount[prevActionLabel]
